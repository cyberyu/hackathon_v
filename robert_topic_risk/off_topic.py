...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U8DU34SLE/F8RGJ480L/off_topic.py?nojsmode=1" /></noscript>
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>off_topic.py | awakens Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/284377050564?crumb=s-1515697137-ad0bae7677-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	...
	Created by robert.fieldhouse on Thursday, January 11, 2018 at 10:13 AM
	</strong><br />
	<span class="subtle_silver break_word">https://awakensworkspace.slack.com/files/U8DU34SLE/F8RGJ480L/off_topic.py</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T8CB31GGL-F8RGJ480L-4532de1411" target="new">https://slack-files.com/T8CB31GGL-F8RGJ480L-4532de1411</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		2KB Python snippet created on <span class="date">January 11, 2018</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">import pickle
import sys
import pandas as pd 
...
refComment = \
&quot;2008 ETF accept account advice age aggressive allocation amount asset averse balance bank bear bitcoin black bond brokerage bubble budget bull buy cash cautious collapse \
...
vectorizedComment = vectorizedFit.transform([processedComment,])
...
<div class="loading_hash_animation">
	...
	<form action="https://awakensworkspace.slack.com/files/U8DU34SLE/F8RGJ480L/off_topic.py"
		...
		<input type="hidden" name="crumb" value="s-1515697137-cdee0ce127-☃" />
...
<!--
	...
	// client boot data
		...
		boot_data.ms_connect_url = "wss:\/\/mpmulti-NPKm.lb.slack-msgs.com\/?flannel=2&token=xoxs-284377050564-283820033873-297508470530-7766fb51a7";
...
<script type="text/javascript" src="https://cfr.slack-edge.com/bv1-1/codemirror_load.ca4f26b018edcede90ce.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F8RGJ480L","created":1515694415,"timestamp":1515694415,"name":"off_topic.py","title":"off_topic.py","mimetype":"text\/plain","filetype":"python","pretty_type":"Python","user":"U8DU34SLE","editable":true,"size":2152,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T8CB31GGL-F8RGJ480L\/off_topic.py","url_private_download":"https:\/\/files.slack.com\/files-pri\/T8CB31GGL-F8RGJ480L\/download\/off_topic.py","permalink":"https:\/\/awakensworkspace.slack.com\/files\/U8DU34SLE\/F8RGJ480L\/off_topic.py","permalink_public":"https:\/\/slack-files.com\/T8CB31GGL-F8RGJ480L-4532de1411","edit_link":"https:\/\/awakensworkspace.slack.com\/files\/U8DU34SLE\/F8RGJ480L\/off_topic.py\/edit","preview":"import pickle\nimport sys\nimport pandas as pd \nfrom nltk.tokenize import word_tokenize\nfrom nltk.corpus import stopwords","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Epickle\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Esys\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Epandas\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eas\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Epd\u003C\/span\u003E \u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Efrom\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Enltk\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Etokenize\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Eword_tokenize\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Efrom\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Enltk\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Ecorpus\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Estopwords\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":55,"lines_more":50,"preview_is_truncated":true,"channels":["C8C9VF1DG"],"groups":[],"ims":[],"comments_count":1,"initial_comment":{"id":"Fc8SJNGXAT","created":1515694415,"timestamp":1515694415,"user":"U8DU34SLE","is_intro":true,"comment":"Hi team, here's the code for the on\/off topic detector. It accepts a user statement and then determines if it's related to a financial or risk conversation."}};
		boot_data.file.comments = [{"id":"Fc8SJNGXAT","created":1515694415,"timestamp":1515694415,"user":"U8DU34SLE","is_intro":true,"comment":"Hi team, here's the code for the on\/off topic detector. It accepts a user statement and then determines if it's related to a financial or risk conversation."}];
...
<!-- slack-www-hhvm-0e6b64b6a203426b5 / 2018-01-11 10:58:57 / v38f90212e4e7e70d67af13a65ebdab9dc206ec79 / B:H -->
